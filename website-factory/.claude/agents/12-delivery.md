...
- QA scores: design-fidelity aggregate + per-region; sop-qa the website template-composition + universal SOP scores; build-fidelity DOM diff result; perf LCP (desktop + mobile)
...
- [ ] All 13 the website template sections rendered in canonical order
- [ ] LeadForm submits (Playwright smoke test the form on the live URL)
- [ ] MobileCtaBar visible + sticky at 375px viewport
